                                    ...
                                    <div className="col-md-6">
                                        <form className="form" onSubmit={e => onSubmit(e)}>
                                            <div className="form-group2">
                                                ...
                                                <input type="text" placeholder="Ex:- Md Arze Hayat" name="name" value={name} className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                                <label htmlFor="email">Email-ID:</label>
                                                <input required name="email" placeholder="Ex:- arze@gmail.com" value={email} type="email" className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                                <label htmlFor="mob-number">Mobile-No.:</label>
                                                <input required id="mob-number" placeholder="Ex:- 8965325647" type="text" name="contact" value={contact} className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                            ...
                                            <div className="form-group2">
                                                ...
                                                <input required id="password" name="password" value={password} placeholder="Ex:-Arze@1234" type="password" className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                                <label htmlFor="password">Re-Password :</label>
                                                <input required id="password2" name="password2" value={password2} placeholder="Ex:-Arze@1234" type="password" className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
